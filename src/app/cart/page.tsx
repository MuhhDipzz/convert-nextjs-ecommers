                        ...
                        {cartItems.map((item) => (
                            <div key={item.id} className="flex gap-4 p-4 glass-card">
                                ...
                                <button
                                    ...
                                    className={`w-5 h-5 rounded-lg flex items-center justify-center flex-shrink-0 transition-all ${item.is_selected ? 'bg-primary' : 'border border-border hover:border-foreground/30'
                                        }`}
                                >
                                ...
                                {/* Image */}
                                <Link href={`/product/${item.product_id}`} className="w-20 h-20 rounded-xl overflow-hidden bg-muted flex-shrink-0">
